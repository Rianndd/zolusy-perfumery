            ...
            <div class="container text-center hero-text font-white">
                ...
                <div class="steps">
                    <div class="step-item step1">
                        ...
                        <h4><span style="color:white;">1. </span>Fresh</h4>
                    </div>
                    <div class="step-item step2">
                        ...
                        <h4><span style="color:white;">2. </span>Sweet</h4>
                    </div>
                    <div class="step-item step3">
                        ...
                        <h4><span style="color:white;">3. </span>Elegant</h4>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="popular">
        <div class="container">
            <div class="title text-xs-center m-b-30">
                <h2>Popular Parfum of the Month</h2>
                <p class="lead">Easiest way to order your favourite parfum</p>
            </div>
            <div class="row">
                <?php
                $query_res = mysqli_query($db, "select * from parfum LIMIT 6");
                while ($r = mysqli_fetch_array($query_res)) {
                    echo    '<div class="col-xs-12 col-sm-6 col-md-4 food-item">
                                    <div class="food-item-wrap">
                                        <div class="figure-wrap bg-image" data-image-src="admin/Res_img/parfum/' . $r['img'] . '"></div>
                                        <div class="content">
                                            <h5><a href="parfum.php?res_id=' . $r['rs_id'] . '">' . $r['title'] . '</a></h5>
                                            <div class="product-name">' . $r['slogan'] . '</div>
                                            <div class="price-btn-block"> <span class="price">$' . $r['price'] . '</span> <a href="parfum.php?res_id=' . $r['rs_id'] . '" class="btn theme-btn-dash pull-right">Order Now</a> </div>
                                        </div>
                ...
                <div class="row how-it-works-solution">
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                        <div class="how-it-works-wrap">
                            <div class="step step-1">
                                ...
                                <h3>Pilih toko kami</h3>
                                <p>Zolusy Perfumery toko parfum recommended.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                        <div class="step step-2">
                            ...
                            <h3>Pilih Jenis Parfum</h3>
                            <p>Pilih wangi parfum sesuai selera</p>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="title-block pull-left">
                        <h4>Rekomendasi parfum dari kami </h4>
                    </div>
                </div>
                <div class="col-sm-8">
                                    ...
                                    <div class="restaurant-wrap">
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-3 col-md-12 col-lg-3 text-xs-center">
                                                <a class="restaurant-logo" href="parfum.php?res_id=' . $rows['rs_id'] . '" > <img src="admin/Res_img/' . $rows['image'] . '" alt="Restaurant logo"> </a>
                                            </div>
