...
if (isset($_POST['submit'])) {
    if (
        ...
        if (!filter_var($_POST['email'], FILTER_VALIDATE_EMAIL)) // Validate email address
        {
            ...
            $mql = "update users set username='$_POST[uname]', name='$_POST[name]', email='$_POST[email]',phone='$_POST[phone]',password='" . md5($_POST['password']) . "' where u_id='$_GET[user_upd]' ";
            mysqli_query($db, $mql);
                                            ...
                                            <div class="row p-t-20">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group has-danger">
                                                        ...
                                                        <input type="text" name="name" class="form-control form-control-danger" value="<?php echo $newrow['name'];  ?>" placeholder="name">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row p-t-20">
