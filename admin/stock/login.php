...
if (isset($_POST['login'])) {
  ...
  if ($hitung > 0) {
    ...
    if ($data['level'] == 'admin') {
      ...
      header('location:laporanstock.php');
    }
  } else {
          ...
          <div class="card-body">
            ...
            <div class="app-brand justify-content-center">
              <a href="index.html" class="app-brand-link gap-2">
                ...
                <span class="app-brand-text demo text-body fw-bolder">Stok Parfum</span>
              </a>
            </div>
            <!-- /Logo -->
            ...
            <form class="mb-3" method="POST">
              <div class="mb-3">
                ...
                <input type="email" class="form-control" id="inputEmailAddress" name="email" placeholder="Enter your email or username" autofocus />
              </div>
