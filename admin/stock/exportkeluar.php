...
$query = "select * from keluar m, stock s where s.idbarang = m.idbarang AND $query_condition ORDER BY tanggal DESC";
...
<head>
    ...
    <title>Laporan Parfum Keluar</title>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h3 class="mt-4">Laporan Parfum Keluar</h3>
                    <div class="card mb-4">
